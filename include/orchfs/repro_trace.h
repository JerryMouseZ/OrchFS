...
enum orchfs_repro_trace_stage {
  ...
  ORCHFS_TRACE_NAMESPACE_WAIT = 20,
  ORCHFS_TRACE_DIRENT_SCAN = 21,
  ORCHFS_TRACE_SNAPSHOT_MAP_COPY = 22,
  ORCHFS_TRACE_RANGE_MAP_COPY = 23,
  ORCHFS_TRACE_JOURNAL_QUEUE_WAIT = 24,
};
